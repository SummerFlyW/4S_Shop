...
var _createClass = function () {
  ...
  return _createClass(t, [{
    key: "getWXLocation", value: function (t, a, e, i) {
      t = t || "gcj02", a = a || function () {
        }, e = e || function () {
        }, i = i || function () {
    ...
    key: "search", value: function (t) {
      ...
      if (t.location) {
        var u = t.location.split(",")[1], r = t.location.split(",")[0], l = "input location", p = {
          errMsg: l,
          latitude: r,
          longitude: u
        };
    ...
    key: "weather", value: function (t) {
      ...
      if (t.location) {
        var u = t.location.split(",")[0], r = t.location.split(",")[1], l = "input location", p = {
          errMsg: l,
          latitude: r,
          longitude: u
        };
